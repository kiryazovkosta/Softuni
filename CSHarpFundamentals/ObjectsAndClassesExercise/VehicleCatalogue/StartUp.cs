...
namespace VehicleCatalogue
{
    ...
    public class Vehicle
    {
        ...
        {
            return
                $"Type: {this.Type.First().ToString().ToUpper()}{this.Type.Substring(1)}{Environment.NewLine}"
    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            Console.WriteLine($"Trucks have average horsepower of: {GetAverageHousePowerByType(vehicles, "truck"):F2}.");
        }
